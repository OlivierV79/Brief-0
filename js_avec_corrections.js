...
let nombre; // pour etre utilisé dans les 2 fonctions nombreAleatoire() et arrondirNombre()
...
var nombre2 = Math.floor(Math.random() * 1000); // code manquant : il faut utiliser la fonction Math.floor() pour obtenir un nombre entier
var chiffre = prompt("Entrez un chiffre");
if (nombre2 % chiffre == 0) {
  console.log("Le nombre " + nombre2 + " est divisible par " + chiffre);
} else {
  console.log("Le nombre " + nombre2 + " n'est pas divisible par " + chiffre);
}
